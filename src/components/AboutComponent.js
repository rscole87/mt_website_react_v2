      ...
      <Container>
        <Row>
          <Col sm="6" className="pt-4 pt-sm-0 pe-sm-5">
            <p className="body-copy"><strong>Marble Theory Design</strong> is a branding and design firm that helps companies put their best foot forward through refined design and stimulating visuals. These creations build a unique brand experience for our clients which can be felt in all touch points.</p>
          ...
          <Col sm="6" className="pt-3 pt-sm-0 ps-sm-5 ps-md-3 d-flex align-items-center"  id="right-col" >
            <h3 className="pull-quote" data-aos="fade-left" data-aos-duration="2000">Collaborative Solutions to Creative Problems</h3>
          </Col>
        </Row>
      </Container>
    </section>
